...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void requestLayout() {
        ...
        /*if (data != null && requestCode == IMAGE_PICKER) {
            List<ImageItem> tempImageList = (ArrayList<ImageItem>) data.getSerializableExtra(ImagePicker.EXTRA_RESULT_ITEMS);
            ...
            if (tempImageList != null && !tempImageList.isEmpty()) {
                ...
                // initImgList();
                File imageFile = null;
                for (ImageItem imageItem : tempImageList) {
                    imageFile = new File(imageItem.path);
                    EnjperyApplication.getInstance().compressWithRx(imageFile, file -> {
                        mSelectImgList.add(file);
