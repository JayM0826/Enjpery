package com.j.enjpery.app.ui.teaminfo;
...
public class TeamInfoActivity extends Activity {
    ...
    private TeamInfoState mState = TeamInfoState.Closed;
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        ...
        Picasso.with(TeamInfoActivity.this).load((Integer) item.get(TeamInfoListAdapter.KEY_AVATAR))
        ...
        ((TextView) mOverlayListItemView.findViewById(R.id.text_view_name)).setText((String) item.get(TeamInfoListAdapter.KEY_NAME));
        ((TextView) mOverlayListItemView.findViewById(R.id.text_view_description)).setText((String) item.get(TeamInfoListAdapter.KEY_DESCRIPTION_SHORT));
    ...
    private void setProfileDetailsInfo(Map<String, Object> item) {
        mTextViewProfileName.setText((String) item.get(TeamInfoListAdapter.KEY_NAME));
        mTextViewProfileDescription.setText((String) item.get(TeamInfoListAdapter.KEY_DESCRIPTION_FULL));
    }
    ...
    public void onBackPressed() {
        if (getState() == TeamInfoState.Opened) {
            animateCloseProfileDetails();
        } else if (getState() == TeamInfoState.Closed) {
            super.onBackPressed();
        }
    }
    ...
    protected BaseAdapter getAdapter() {
        ...
        int[] avatars = {
                R.drawable.tomorrow, R.drawable.anonymous};
        String[] names = getResources().getStringArray(R.array.array_names);

        for (int i = 0; i < avatars.length; i++) {
            profileMap = new HashMap<>();
            profileMap.put(TeamInfoListAdapter.KEY_AVATAR, avatars[i]);
            profileMap.put(TeamInfoListAdapter.KEY_NAME, names[i]);
            profileMap.put(TeamInfoListAdapter.KEY_DESCRIPTION_SHORT, getString(R.string.lorem_ipsum_short));
            profileMap.put(TeamInfoListAdapter.KEY_DESCRIPTION_FULL, getString(R.string.lorem_ipsum_long));
            profilesList.add(profileMap);
        }

        return new TeamInfoListAdapter(this, R.layout.list_item, profilesList);
    }
