 ...
 */
public class TeamInfoListAdapter extends ArrayAdapter<Map<String, Object>> {
    ...
    public TeamInfoListAdapter(Context context, int layoutResourceId, List<Map<String, Object>> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(getContext()).load((Integer) mData.get(position).get(KEY_AVATAR))
                .resize(TeamInfoActivity.sScreenWidth, TeamInfoActivity.sProfileImageHeight).centerCrop()
        ...
        viewHolder.mViewOverlay.setBackground(TeamInfoActivity.sOverlayShape);
